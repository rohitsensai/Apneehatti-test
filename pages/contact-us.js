...
<section class="bg-light w-full  rounded border-rounded my-20">
              ...
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-5 mb-sm-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="tel:+15057922430">07876752516</a>
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="d-flex mb-0">
                  ...
                  <div>
                    ...
                    <p class="mb-0">
                      <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">anubhav.sharma@apneehatti.com</a>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="d-flex">
              ...
              <div>
                ...
                <div class="d-flex mb-1">
                  ...
                  <p class="text-secondary mb-0">Open 24 hours</p>
                </div>
                <div class="d-flex">
